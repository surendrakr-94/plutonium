...
const authorModel = require("../models/AuthorModelsk")


const createAuthorsky = async function (req, res) {
    let data = req.body
    let savedData = await authorModel.create(data)
    res.send({ msg: savedData })
}

const createBooksky = async function (req, res) {
    let data = req.body
...
const getBookskyData = async function (req, res) {
...
const skfindauthor = async function (req, res) {
...
const skfindBooks = async function (req, res) {
...
//creating author
module.exports.createAuthorsky = createAuthorsky
//creating for book 
module.exports.createBooksky = createBooksky

// getting books 
module.exports.getBookskyData = getBookskyData

//2nd 
module.exports.skfindauthor = skfindauthor

//3rd
module.exports.skfindBooks = skfindBooks
